...
Cursorで新しく利用可能になった「Composer 2.5」は、従来のComposer 2から大きく進化したコーディング向けAIモデルです。

今回のアップデートでは、単にベンチマークのスコアを上げるだけではなく、実際に開発で使ったときの「作業の続けやすさ」「指示への従いやすさ」「人間との協働しやすさ」が重視されています。

特に、長時間にわたる複雑な開発タスクを任せる場面で、より粘り強く、より自然に作業できるようになった点が大きな特徴です。
...
AIモデルの性能は、ベンチマークの点数だけでは測れません。実際の開発では、次のような要素も重要になります。
