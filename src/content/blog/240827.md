...
[VocabBoost](https://play.google.com/store/apps/details?id=com.yuuki.ja.vocabboost)は、私の英語力を向上させたいという思いから生まれた語学学習アプリです。学生時代に英語の基礎が十分に身についていなかったことを振り返り、まずは基本的な英単語の習得から始めることにしました。このアプリを通じて、効率的に英単語を学び、英語でのコミュニケーションをスムーズに行えるようになりたいという思いが、開発の原動力となりました。
...
これから同じように Web からモバイル開発に挑戦する方々へ：最初は戸惑うこともあるかもしれませんが、根気強く取り組めば必ず道は開けます。ぜひ挑戦してみてください！

次回は、このアプリのリリースプロセスや、ユーザーフィードバックを基にした改善について書いていきたいと思います。

リリース作業が以外に大変だった。
画像作成したりなどいろいろあるが、普段開発だけしている身からすると大変。
googleのPlayストアに公開まで出来たので良ければ下記のリンクからダウンロードしていただけると嬉しいです。
[VocabBoost](https://play.google.com/store/apps/details?id=com.yuuki.ja.vocabboost)
